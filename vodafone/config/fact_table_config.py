...
JS_FACT_CONFIG = {
    ...
    "vodafone_fact_inbound_report" : {
        ...
        "source_tables" : [
            {"table_name" : "acd_call_interval_summary" , "date_column" : "report_date"},
            {"table_name" : "acd_call_details" , "date_column" : "report_date"},
            {"table_name" : "custom_pool_report" , "date_column" : "report_date"},
            {"table_name" : "custom_tagging" , "date_column" : "report_date"},
        ],
    },
