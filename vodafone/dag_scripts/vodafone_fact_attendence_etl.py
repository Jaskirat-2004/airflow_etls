"""
PROGRAMMER : JASKIRAT 
INFO : VODAFONE ATTENDENCE FACT TABLE ETL 
"""
# JS ================================== IMPORTS ================================== JS
...
from vodafone.config.fact_table_config import JS_FACT_CONFIG

from vodafone.util.vodafone_util import (
...
SOURCE_DATABASE = "vodafone"

# CLICKHOUSE
DESTINATION_CONN_ID = "DI-CLICKHOUSE"
DESTINATION_DATABASE = "vodafone"

# TABLE LIST
JS_FACT_TABLES = ["vodafone_fact_attendance_report"]
...
@dag(
    dag_id="vodafone_fact_attendance_etl",
    start_date=pendulum.datetime(2026,1,1),
    catchup=False,
    schedule = None,
    tags=["vodafone","fact","attendance","report"],
    default_args=default_args,
)
def vodafone_fact_attendance_etl():

    logger.info("JS ====== DAG STARTED : [vodafone_fact_attendance_etl] ===== JS")
