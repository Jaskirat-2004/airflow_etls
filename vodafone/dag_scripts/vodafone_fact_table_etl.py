...
from vodafone.config.fact_table_config import JS_FACT_TABLES, JS_FACT_CONFIG
...
@dag(
    dag_id="vodafone_fact_table_etl",
    start_date=pendulum.datetime(2026,1,1),
    catchup=False,
    schedule = None,
    tags=["vodafone","fact","crm","report"],
    default_args=default_args,
)
def vodafone_fact_table_etl():

    logger.info("JS ====== DAG STARTED : [vodafone_fact_table_etl] ===== JS")
