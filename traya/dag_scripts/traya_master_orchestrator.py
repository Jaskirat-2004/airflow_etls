"""
PROGRAMMER : JASKIRAT 
INFO : TRAYA MASTER ORCHESTRATOR
"""
# JS ================================== IMPORTS ================================== JS
...
@dag(
    dag_id = "traya_master_orchestrator",
...
def master_orchestrator():
    ...
    trigger_etl = TriggerDagRunOperator(
        task_id="trigger_etl",
        trigger_dag_id="traya_fact_table_etl",
    ...
    trigger_roster_upsert = TriggerDagRunOperator(
        ...
        trigger_dag_id="traya_roster_upsert",
        wait_for_completion=True,
        poke_interval=30,
        failed_states=["failed"],
    )
    ...
    trigger_attendence = TriggerDagRunOperator(
        ...
        trigger_dag_id="traya_fact_attendence_etl",
        wait_for_completion=True,
        poke_interval=30,
        failed_states=["failed"],
    )
