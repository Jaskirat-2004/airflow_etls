"""
PROGRAMMER : JASKIRAT 
INFO : TRAYA ATTENDENCE FACT TABLE ETL 
"""
# JS ================================== IMPORTS ================================== JS
...
from traya.config.fact_table_config import JS_FACT_CONFIG
...
# TABLE LIST
JS_FACT_TABLES = ["traya_fact_attendance_report"]
...
@dag(
    dag_id="traya_fact_attendance_etl",
    start_date=pendulum.datetime(2026,1,1),
    catchup=False,
    schedule = None,
    tags=["traya","fact","attendance","report"],
    default_args=default_args,
)
def traya_fact_attendance_etl():

    logger.info("JS ====== DAG STARTED : [traya_fact_attendance_etl] ===== JS")
