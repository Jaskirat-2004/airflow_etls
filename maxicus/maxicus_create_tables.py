"""
PROGRAMMER : JASKIRAT
INFO : MAXICUS TABLE REPLICATION
"""
...
from lms.config.maxicus_config import ENABLED_TABLES, TABLES_CONFIG
...
# ============== DAG DEFINITION ==============
@dag(
    dag_id="maxicus_create_tables",
    start_date=pendulum.datetime(2026, 1, 1),
    schedule=None,
    catchup=False,
    tags=["maxicus"]
)
def maxicus_create_tables():
