"""
PROGRAMMER : JASKIRAT 
INFO : EULERMOTORS FACT TABLE ETL 
"""
# JS ================================== IMPORTS ================================== JS
...
@dag(
    dag_id="euler_fact_table_etl",
    start_date=pendulum.datetime(2026,1,1),
    catchup=False,
    schedule = None,
    tags=["euler","fact","wfm","report"],
    default_args=default_args,
)
def euler_fact_table_etl():

    logger.info("JS ====== DAG STARTED : [euler_fact_table_etl] ===== JS")
