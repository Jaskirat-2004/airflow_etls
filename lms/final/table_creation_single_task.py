...
# One task instead of two. No file written anywhere. ClickHouse and Postgres connections open at the start, then loop through every table — read schema, build SQL in memory, execute immediately, commit, move on. If a table fails only that table is affected, the rest continue.

# The output in your task log will look like:
# ```
# ClickHouse OK
# PostgreSQL OK

# [courses] Reading schema from ClickHouse...
# [courses] Executing in PostgreSQL...
# [courses] Done (23 columns + client_name)

# [CourseModule] Reading schema from ClickHouse...
# [CourseModule] Executing in PostgreSQL...
# [CourseModule] Done (8 columns + client_name)
# ...
# ===================================================
# Created : 19/19 tables
# Tables confirmed in PostgreSQL (19 total):
#   Batch
#   BatchToCourse
#   ...
